        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#create" role="tab">Create Book</a>
                    </li>
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="btn-group m-b-10">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                href="{{route('book.edit',$value->id)}}">{{ $value->b_state == 1 ? 'Inactive' :'Active'}}</a>
                                                                <button class="dropdown-item" data-toggle="modal"
                                                                    data-target=".bd-example-modal-form-{{$value->id}}">Edit</button>
                                                                <div class="dropdown-divider"></div>
                                                                <form
                                                                    action="{{route('book.destroy',$value->id)}}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                                ...
                                                <div class="modal fade bd-example-modal-form-{{$value->id}}"
                                                    ...
                                                    aria-hidden="true">
                                                    <form action="{{route('book.update',$value->id)}}"
                                                        method="post">
                                                        @method('PUT')
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-check form-check-flat form-check-primary">
                                                                                    <label class="form-check-label">
                                                                                        <input type="checkbox" {{ $value->b_state == 1 ?'checked' : '' }} name="state" class="form-check-input"> Active </label>
                                                                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control {{ $errors->has('name')? 'is-invalid' : '' }}"
                                         type="text" required="" name="name" placeholder="Book Name"
                                        value="{{old('name')}}">
                                    @if($errors->has('name'))
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control {{ $errors->has('amount')? 'is-invalid' : '' }}"
                                         type="number" required="" name="amount" placeholder="Book Amount"
                                        value="{{old('amount')}}">
